...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        GorevYoneticisi.Models.LoggedUserModel usr = GorevYoneticisi.Tools.GetCurrentUser.GetUser();
        if (usr != null)
        {
            return true;
        }
        ...
        /*VarulfCMSV1.Models.yoneticiler yntc = VarulfCMSV1.Areas.Admin.AdminTools.GetCurrentUser.GetUserAdmin();
        if (yntc != null)
        {
            return true;
        }
	...
	public override void SetConfig()
	{
		...
		BaseUrl = "/public/upload/img/ckImages/";
